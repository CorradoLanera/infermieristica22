...
meta() %>%
  ...
  meta_social(
    title = "Management, Medicina Legale, Epidemiologia e Statistica",
    url = "https:///infermieristica22-slide",
...
- apprendere le conoscenze teoriche di base della EPIDEMIOLOGIA E STATISTICA
...
- imparare le definizioni e gli operatori base della EPIDEMIOLOGIA E STATISTICA,
...
- Zoom: [bit.ly/infermieristica22-zoom](https://bit.ly/infermieristica22-zoom),
  accessibile anche dal link sul Moodle del corso.

- Materiale didattico: Moodle [bit.ly/infermieristica22-moodle](https://bit.ly/infermieristica22-moodle)

- Portale accesso slide: [bit.ly/infermieristica22-slide](https://bit.ly/infermieristica22-slide)
...
- Lezione 5: giovedì 15 novembre 2022 - 08:30-12:30
  + (30') ricapitolazione, domande, dubbi e perplessità
...
gratuitamente su RStudio Cloud collegandosi all'indirizzo: [bit.ly/infermieristica22-rscloud](https://bit.ly/infermieristica22-rscloud)
...
- **Ricevimento**: sono disponibile a 
  ricevere gli studenti per 25 minuti a sessione in qualunque giorno o momento in cui non sia già impegnato; l'appuntamento è prenotabile con almeno tre giorni di anticipo, ed entro tre settimane, tramite il link (disponibile su Moodle e riservato esclusivamente agli studenti del
  corso):
  
  [bit.ly/infermieristica22-ricevimento](https://bit.ly/infermieristica22-ricevimento).
